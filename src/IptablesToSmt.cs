...
module IptablesToSmt {
  ...
  method MaybeAppend(conds: seq<string>, fieldName: string, crit: FieldMatch)
      returns (updated: seq<string>)
    decreases conds, fieldName, crit
  {
    match crit
    case {:split false} MatchExact(value) =>
      var literal := FormatStringLiteral(value);
      var fragment := ""(= "" + fieldName + "" "" + literal + "")"";
      updated := conds + [fragment];
    case {:split false} MatchAny() =>
      updated := conds;
  }
  ...
  {
    match target
    case {:split false} TargetAccept() =>
      value := ""ACCEPT"";
    case {:split false} TargetDrop() =>
      value := ""DROP"";
    case {:split false} TargetReject() =>
      value := ""REJECT"";
    case {:split false} TargetReturn() =>
      value := ""RETURN"";
    case {:split false} TargetJump(name) =>
      value := name;
  }
  ...
  method SplitLines(text: string) returns (lines: seq<string>)
    ensures forall l: seq<char> {:trigger |l|} {:trigger l in lines} :: l in lines ==> |l| <= |text|
    decreases text
  {
    if |text| == 0 {
      lines := [];
    ...
    while i < |text|
      ...
      invariant start <= i
      invariant i <= |text|
      invariant forall l: seq<char> {:trigger |l|} {:trigger l in segments} :: l in segments ==> |l| <= |text|
      decreases |text| - i
    {
      var ch := text[i];
      if ch == '\n' {
...
namespace IptablesToSmt {
  ...
  public partial class __default {
    ...
    public static void ParseRuleTokens(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> tokens, BigInteger lineNumber, Dafny.ISequence<Dafny.Rune> rawLine, out IptablesToSmt._IRule rule, out bool ok)
    {
      ...
      IptablesToSmt._IFieldMatch _1_src;
      _1_src = IptablesToSmt.FieldMatch.create_MatchAny();
      IptablesToSmt._IFieldMatch _2_dst;
      _2_dst = IptablesToSmt.FieldMatch.create_MatchAny();
      IptablesToSmt._IFieldMatch _3_proto;
      _3_proto = IptablesToSmt.FieldMatch.create_MatchAny();
      IptablesToSmt._IFieldMatch _4_srcPort;
      _4_srcPort = IptablesToSmt.FieldMatch.create_MatchAny();
      IptablesToSmt._IFieldMatch _5_dstPort;
      _5_dstPort = IptablesToSmt.FieldMatch.create_MatchAny();
      IptablesToSmt._ITarget _6_target;
      _6_target = IptablesToSmt.Target.create_TargetReturn();
      bool _7_targetSet;
      _7_targetSet = false;
      BigInteger _8_i;
      _8_i = new BigInteger(2);
      while ((_8_i) < (new BigInteger((tokens).Count))) {
        Dafny.ISequence<Dafny.Rune> _9_flag;
        _9_flag = (tokens).Select(_8_i);
        if (((_9_flag).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("-s"))) && (((_8_i) + (BigInteger.One)) < (new BigInteger((tokens).Count)))) {
          _1_src = IptablesToSmt.FieldMatch.create_MatchExact((tokens).Select((_8_i) + (BigInteger.One)));
          _8_i = (_8_i) + (new BigInteger(2));
          goto continue_0;
        }
        if (((_9_flag).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("-d"))) && (((_8_i) + (BigInteger.One)) < (new BigInteger((tokens).Count)))) {
          _2_dst = IptablesToSmt.FieldMatch.create_MatchExact((tokens).Select((_8_i) + (BigInteger.One)));
          _8_i = (_8_i) + (new BigInteger(2));
          goto continue_0;
        }
        if (((_9_flag).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("-p"))) && (((_8_i) + (BigInteger.One)) < (new BigInteger((tokens).Count)))) {
          _3_proto = IptablesToSmt.FieldMatch.create_MatchExact((tokens).Select((_8_i) + (BigInteger.One)));
          _8_i = (_8_i) + (new BigInteger(2));
          goto continue_0;
        }
        if (((_9_flag).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("-j"))) && (((_8_i) + (BigInteger.One)) < (new BigInteger((tokens).Count)))) {
          IptablesToSmt._ITarget _out0;
          _out0 = IptablesToSmt.__default.ParseTarget((tokens).Select((_8_i) + (BigInteger.One)));
          _6_target = _out0;
          _7_targetSet = true;
          _8_i = (_8_i) + (new BigInteger(2));
          goto continue_0;
        }
        if (((_9_flag).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("--sport"))) && (((_8_i) + (BigInteger.One)) < (new BigInteger((tokens).Count)))) {
          _4_srcPort = IptablesToSmt.FieldMatch.create_MatchExact((tokens).Select((_8_i) + (BigInteger.One)));
          _8_i = (_8_i) + (new BigInteger(2));
          goto continue_0;
        }
        if (((_9_flag).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("--dport"))) && (((_8_i) + (BigInteger.One)) < (new BigInteger((tokens).Count)))) {
          _5_dstPort = IptablesToSmt.FieldMatch.create_MatchExact((tokens).Select((_8_i) + (BigInteger.One)));
          _8_i = (_8_i) + (new BigInteger(2));
          goto continue_0;
        }
        rule = IptablesToSmt.Rule.create(Dafny.Sequence<Dafny.Rune>.UnicodeFromString(""), IptablesToSmt.FieldMatch.create_MatchAny(), IptablesToSmt.FieldMatch.create_MatchAny(), IptablesToSmt.FieldMatch.create_MatchAny(), IptablesToSmt.FieldMatch.create_MatchAny(), IptablesToSmt.FieldMatch.create_MatchAny(), IptablesToSmt.Target.create_TargetReturn(), lineNumber, rawLine);
    ...
    after_0: ;
      rule = IptablesToSmt.Rule.create(_0_chain, _1_src, _2_dst, _3_proto, _4_srcPort, _5_dstPort, _6_target, lineNumber, rawLine);
      ok = _7_targetSet;
    }
    public static Dafny.ISequence<Dafny.Rune> BuildSmtDocument(Dafny.ISequence<IptablesToSmt._IRule> rules)
    {
      ...
      while ((_1_i) < (new BigInteger((rules).Count))) {
        ...
        Dafny.ISequence<Dafny.Rune> _out0;
        _out0 = IptablesToSmt.__default.FormatRule((rules).Select(_1_i), _1_i);
        _2_formatted = _out0;
    ...
    {
      Dafny.ISequence<Dafny.Rune> formatted = Dafny.Sequence<Dafny.Rune>.Empty;
      Dafny.ISequence<Dafny.Rune> _0_indexText;
      Dafny.ISequence<Dafny.Rune> _out0;
      _out0 = IptablesToSmt.__default.IntToString(index);
      _0_indexText = _out0;
      Dafny.ISequence<Dafny.Rune> _1_lineText;
      Dafny.ISequence<Dafny.Rune> _out1;
      _out1 = IptablesToSmt.__default.IntToString((rule).dtor_lineNumber);
      _1_lineText = _out1;
      Dafny.ISequence<Dafny.Rune> _2_header;
      _2_header = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("; Rule "), _0_indexText), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" (line ")), _1_lineText), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("): ")), (rule).dtor_original), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n"));
      Dafny.ISequence<Dafny.Rune> _3_def;
      _3_def = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("(define-fun rule"), _0_indexText), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" ((pkt_chain String) (pkt_src String) (pkt_dst String) (pkt_proto String) (pkt_sport String) (pkt_dport String)) Bool\n"));
      Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _4_conditions;
      Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _out2;
      _out2 = IptablesToSmt.__default.BuildRuleConditions(rule);
      _4_conditions = _out2;
      Dafny.ISequence<Dafny.Rune> _5_condBuilder;
      _5_condBuilder = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("");
      if ((new BigInteger((_4_conditions).Count)).Sign == 0) {
        _5_condBuilder = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("  true\n");
      } else {
        _5_condBuilder = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("  (and\n");
        BigInteger _6_i;
        _6_i = BigInteger.Zero;
        while ((_6_i) < (new BigInteger((_4_conditions).Count))) {
          _5_condBuilder = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(_5_condBuilder, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("    ")), (_4_conditions).Select(_6_i)), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n"));
          _6_i = (_6_i) + (BigInteger.One);
        }
        _5_condBuilder = Dafny.Sequence<Dafny.Rune>.Concat(_5_condBuilder, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("  )\n"));
      }
      Dafny.ISequence<Dafny.Rune> _7_closing;
      _7_closing = Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")\n");
      Dafny.ISequence<Dafny.Rune> _8_targetLiteral;
      Dafny.ISequence<Dafny.Rune> _out3;
      _out3 = IptablesToSmt.__default.FormatTargetLiteral((rule).dtor_target);
      _8_targetLiteral = _out3;
      Dafny.ISequence<Dafny.Rune> _9_action;
      _9_action = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("(assert (=> (rule"), _0_indexText), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" packet_chain packet_src packet_dst packet_proto packet_sport packet_dport)\n")), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("            (= packet_action ")), _8_targetLiteral), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")))\n"));
      formatted = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(_2_header, _3_def), _5_condBuilder), _7_closing), _9_action);
      return formatted;
    }
    public static Dafny.ISequence<Dafny.Rune> IntToString(BigInteger n)
    {
      Dafny.ISequence<Dafny.Rune> text = Dafny.Sequence<Dafny.Rune>.Empty;
      if ((n).Sign == 0) {
        text = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("0");
        return text;
      }
      Dafny.ISequence<Dafny.Rune> _0_prefix;
      _0_prefix = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("");
      BigInteger _1_value;
      _1_value = n;
      if ((n).Sign == -1) {
        _0_prefix = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("-");
        _1_value = (BigInteger.Zero) - (n);
      }
      Dafny.ISequence<Dafny.Rune> _2_digits;
      _2_digits = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("");
      while ((_1_value).Sign == 1) {
        BigInteger _3_digit;
        _3_digit = Dafny.Helpers.EuclideanModulus(_1_value, new BigInteger(10));
        Dafny.ISequence<Dafny.Rune> _4_digitString;
        Dafny.ISequence<Dafny.Rune> _out0;
        _out0 = IptablesToSmt.__default.DigitToString(_3_digit);
        _4_digitString = _out0;
        _2_digits = Dafny.Sequence<Dafny.Rune>.Concat(_4_digitString, _2_digits);
        _1_value = Dafny.Helpers.EuclideanDivision(_1_value, new BigInteger(10));
      }
      text = Dafny.Sequence<Dafny.Rune>.Concat(_0_prefix, _2_digits);
      return text;
    }
    public static Dafny.ISequence<Dafny.Rune> DigitToString(BigInteger d)
    {
      Dafny.ISequence<Dafny.Rune> text = Dafny.Sequence<Dafny.Rune>.Empty;
      Dafny.ISequence<Dafny.Rune> _0_digitsLiteral;
      _0_digitsLiteral = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("0123456789");
      text = (_0_digitsLiteral).Subsequence(d, (d) + (BigInteger.One));
      return text;
    }
    public static Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> BuildRuleConditions(IptablesToSmt._IRule rule)
    {
      Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> conditions = Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.Empty;
      Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _0_conds;
      _0_conds = Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements();
      Dafny.ISequence<Dafny.Rune> _1_chainLiteral;
      Dafny.ISequence<Dafny.Rune> _out0;
      _out0 = IptablesToSmt.__default.FormatStringLiteral((rule).dtor_chain);
      _1_chainLiteral = _out0;
      _0_conds = Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.Concat(_0_conds, Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("(= pkt_chain "), _1_chainLiteral), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"))));
      Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _out1;
      _out1 = IptablesToSmt.__default.MaybeAppend(_0_conds, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("pkt_src"), (rule).dtor_source);
      _0_conds = _out1;
      Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _out2;
      _out2 = IptablesToSmt.__default.MaybeAppend(_0_conds, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("pkt_dst"), (rule).dtor_destination);
      _0_conds = _out2;
      Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _out3;
      _out3 = IptablesToSmt.__default.MaybeAppend(_0_conds, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("pkt_proto"), (rule).dtor_protocol);
      _0_conds = _out3;
      Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _out4;
      _out4 = IptablesToSmt.__default.MaybeAppend(_0_conds, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("pkt_sport"), (rule).dtor_srcPort);
      _0_conds = _out4;
      Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _out5;
      _out5 = IptablesToSmt.__default.MaybeAppend(_0_conds, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("pkt_dport"), (rule).dtor_dstPort);
      _0_conds = _out5;
      conditions = _0_conds;
      return conditions;
    }
    ...
    {
      Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> updated = Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.Empty;
      IptablesToSmt._IFieldMatch _source0 = crit;
      {
        if (_source0.is_MatchExact) {
          Dafny.ISequence<Dafny.Rune> _0_value = _source0.dtor_value;
          Dafny.ISequence<Dafny.Rune> _1_literal;
          Dafny.ISequence<Dafny.Rune> _out0;
          _out0 = IptablesToSmt.__default.FormatStringLiteral(_0_value);
          _1_literal = _out0;
          Dafny.ISequence<Dafny.Rune> _2_fragment;
          _2_fragment = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("(= "), fieldName), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" ")), _1_literal), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"));
          updated = Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.Concat(conds, Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(_2_fragment));
          goto after_match0;
        }
      }
      {
    ...
    {
      Dafny.ISequence<Dafny.Rune> literal = Dafny.Sequence<Dafny.Rune>.Empty;
      Dafny.ISequence<Dafny.Rune> _0_targetText;
      Dafny.ISequence<Dafny.Rune> _out0;
      _out0 = IptablesToSmt.__default.TargetToString(target);
      _0_targetText = _out0;
      Dafny.ISequence<Dafny.Rune> _out1;
      _out1 = IptablesToSmt.__default.FormatStringLiteral(_0_targetText);
      literal = _out1;
      return literal;
    }
    public static Dafny.ISequence<Dafny.Rune> TargetToString(IptablesToSmt._ITarget target)
    {
      Dafny.ISequence<Dafny.Rune> @value = Dafny.Sequence<Dafny.Rune>.Empty;
      IptablesToSmt._ITarget _source0 = target;
      {
        if (_source0.is_TargetAccept) {
          @value = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("ACCEPT");
          goto after_match0;
        }
      }
      {
        if (_source0.is_TargetDrop) {
          @value = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("DROP");
          goto after_match0;
        }
      }
      {
        if (_source0.is_TargetReject) {
          @value = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("REJECT");
          goto after_match0;
        }
      }
      {
        if (_source0.is_TargetReturn) {
          @value = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("RETURN");
          goto after_match0;
        }
      }
      {
    ...
    {
      Dafny.ISequence<Dafny.Rune> encoded = Dafny.Sequence<Dafny.Rune>.Empty;
      Dafny.ISequence<Dafny.Rune> _0_escaped;
      Dafny.ISequence<Dafny.Rune> _out0;
      _out0 = IptablesToSmt.__default.EscapeForSmt(text);
      _0_escaped = _out0;
      encoded = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\""), _0_escaped), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\""));
      return encoded;
    }
    public static Dafny.ISequence<Dafny.Rune> EscapeForSmt(Dafny.ISequence<Dafny.Rune> text)
    {
      Dafny.ISequence<Dafny.Rune> encoded = Dafny.Sequence<Dafny.Rune>.Empty;
      Dafny.ISequence<Dafny.Rune> _0_builder;
      _0_builder = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("");
      BigInteger _1_i;
      _1_i = BigInteger.Zero;
      while ((_1_i) < (new BigInteger((text).Count))) {
        Dafny.Rune _2_ch;
        _2_ch = (text).Select(_1_i);
        if (((_2_ch) == (new Dafny.Rune('"'))) || ((_2_ch) == (new Dafny.Rune('\\')))) {
          _0_builder = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(_0_builder, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\\")), (text).Subsequence(_1_i, (_1_i) + (BigInteger.One)));
        } else {
          _0_builder = Dafny.Sequence<Dafny.Rune>.Concat(_0_builder, (text).Subsequence(_1_i, (_1_i) + (BigInteger.One)));
        }
        _1_i = (_1_i) + (BigInteger.One);
      }
      encoded = _0_builder;
    ...
    public static Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> SplitLines(Dafny.ISequence<Dafny.Rune> text)
    {
      ...
      if ((new BigInteger((text).Count)).Sign == 0) {
        lines = Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements();
        return lines;
      }
      ...
      while ((_2_i) < (new BigInteger((text).Count))) {
        ...
        } else if ((_3_ch) == (new Dafny.Rune('\r'))) {
          Dafny.ISequence<Dafny.Rune> _5_part;
          _5_part = (text).Subsequence(_1_start, _2_i);
          _0_segments = Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.Concat(_0_segments, Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(_5_part));
          if ((((_2_i) + (BigInteger.One)) < (new BigInteger((text).Count))) && (((text).Select((_2_i) + (BigInteger.One))) == (new Dafny.Rune('\n')))) {
      ...
      if ((_1_start) <= (new BigInteger((text).Count))) {
        _0_segments = Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.Concat(_0_segments, Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements((text).Subsequence(_1_start, new BigInteger((text).Count))));
      }
      lines = _0_segments;
      return lines;
    }
